...
export const SECTIONS: readonly Section[] = [
  ...
  // Прототипы собирает менеджер сразу после первички, пока разговор свежий:
  // это его инструмент, а не владельческий. Показать нечего — черновик
  // наружу не уходит сам, ссылка на него отдаёт 404.
  { href: "/admin/proto", label: "Прототипы", roles: EVERYONE },
