...
export const ACTION_LABEL: Record<AuditAction, string> = {
  ...
  "candidate.reviewed": "разобрал резюме кандидата",
  "candidate.dropped": "убрал разбор кандидата",
  "prospect.queued": "отправил первое сообщение по сайту",
  "prospect.manual_sent": "связался сам — со своего аккаунта, звонком или в WhatsApp",
  "prospect.manual_reply": "перенёс ответ клиента из своей переписки",
  ...
  "razbor.unpublished": "снял разбор с публикации",
  "razbor.edited": "поправил текст разбора",
  "razbor.deleted": "удалил разбор",
  ...
  "expense.added": "записал расход студии",
  "expense.removed": "удалил расход студии",
  "project.share_set": "задал процент по сделке вручную",
  "partner.created": "завёл партнёра",
  "partner.link_created": "создал партнёрскую ссылку",
