  ...
  input_schema: {
    ...
    properties: {
      contact_name: {
        type: "string",
        description:
          "Имя собеседника, как он себя назвал. Если имя не прозвучало — верни ровно пустую строку и ничего больше: ни прочерка, ни пояснения, ни догадки по нику. Пустое поле честно читается как «не представился», выдуманное имя менеджер произнесёт вслух и ошибётся.",
      },
      company: {
        type: "string",
        description:
          "Название компании, как её назвал собеседник. Если не называл — верни ровно пустую строку и ничего больше.",
      },
      contact_handle: {
        type: "string",
        description:
