...
export type ScoutPulse = {
  ...
  chatsReading: number;
  /**
   * Какие именно не читаются: аккаунт в них не состоит или адрес не открылся.
   *
   * Одного числа «12 из 29» мало: вступать приходится руками, и без списка
   * непонятно куда. Раньше названия были только в журнале сервера.
   */
  unread?: string[];
