...
/**
 * Страница инструкций без входа и чтения адреса — только разметка.
 *
 * Отдельно от page.tsx, чтобы её можно было отрисовать с любой ролью и
 * языком без сессии: так проверяется, что видит новичок-менеджер, не
 * заводя тестового сотрудника.
 */
