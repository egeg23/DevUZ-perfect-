...
const ru = {
  ...
  cases: {
    ...
    compareHint: "Потяните ползунок: слева сайт, каким он был, справа — тот, что сделали мы.",
    compareBefore: "Было",
    compareAfter: "Стало",
    ...
    compareNote: "Первый экран, снимок — {date}. Слева {site}, справа наша версия.",
  },
  /**
...
const en: Dictionary = {
  ...
  cases: {
    ...
    compareHint: "Drag the slider: on the left, the site as it was; on the right, the one we built.",
    ...
    compareNote: "First screen, captured {date}. Left: {site}; right: our version.",
  },
  devuz: {
    kicker: "this site",
...
const uz: Dictionary = {
  ...
  cases: {
    ...
    compareHint: "Slayderni suring: chapda sayt qanday bo‘lgan, o‘ngda — biz qilgani.",
    compareBefore: "Oldin",
    compareAfter: "Keyin",
    ...
    compareNote: "Birinchi ekran, surat sanasi — {date}. Chapda {site}, o‘ngda bizning versiya.",
  },
  devuz: {
    kicker: "shu sayt",
...
const zh: Dictionary = {
  ...
  cases: {
    ...
    year: "年份",
    compareTitle: "改版前后",
    compareHint: "拖动滑块：左边是原来的网站，右边是我们做的网站。",
    compareBefore: "改版前",
    compareAfter: "改版后",
    compareDesktop: "电脑",
    compareMobile: "手机",
    ...
    compareNote: "首屏截图，拍摄于 {date}。左边是 {site}，右边是我们的版本。",
  },
  devuz: {
    kicker: "本站",
