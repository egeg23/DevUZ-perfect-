...
const ru = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Что за AI-менеджер в чате?", a: "Первая линия общения на нашей кастомной LLM-сборке. Он отвечает круглосуточно, разбирается в задаче и передаёт живому менеджеру готовое резюме. Скидки и финальные цены он не называет — это работа человека." },
  ...
  contact: {
    ...
    description:
      "Расскажите о задаче в чате. Ассистент на кастомной LLM ответит за секунды, разберётся в проекте и передаст живому менеджеру готовое резюме — вам не придётся повторять всё заново.",
...
const en: Dictionary = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "What is the AI manager in the chat?", a: "A first line of contact running on our own custom LLM setup. It replies around the clock, works out the brief and hands a finished summary to a human manager. It never quotes final prices or discounts — that is a person's job." },
  ...
  contact: {
    ...
    description:
      "Tell us about the project in the chat. The assistant, running on a custom LLM, replies in seconds, works out the brief and hands a finished summary to a human manager — so you never have to repeat yourself.",
...
const uz: Dictionary = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Chatdagi AI-menejer nima?", a: "Bizning maxsus LLM yig‘masimizdagi muloqotning birinchi liniyasi. U kunu tun javob beradi, vazifani tushunadi va tirik menejerga tayyor xulosani uzatadi. Chegirma va yakuniy narxlarni u aytmaydi — bu insonning ishi." },
  ...
  contact: {
    ...
    description:
      "Vazifa haqida chatda gapiring. Maxsus LLM asosidagi yordamchi soniyalarda javob beradi, loyihani tushunadi va tirik menejerga tayyor xulosani uzatadi — hammasini qaytadan takrorlashingizga to‘g‘ri kelmaydi.",
...
const zh: Dictionary = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "聊天里的 AI 客户经理是什么？", a: "运行在我们自有定制 LLM 之上的第一线接待。它全天候回复，厘清需求后把整理好的摘要交给真人经理。它不会给出最终报价或折扣 —— 那是人来做的事。" },
  ...
  contact: {
    ...
    description:
      "在聊天中说说你的项目。运行在定制 LLM 上的助手会在数秒内回复，厘清需求后把整理好的摘要交给真人经理 —— 你不必再把情况重复一遍。",
    formTitle: "或者留下联系方式",
    name: "您的称呼",
