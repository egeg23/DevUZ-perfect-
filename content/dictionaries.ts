...
const ru = {
  ...
  cases: {
    ...
    tech: "Технологии",
    year: "Год",
    compareTitle: "Было и стало",
    compareHint: "Раздел за разделом, в тех же пунктах: слева сайт, каким он был, справа — тот, что сделали мы. Потяните ползунок.",
    compareBefore: "Было",
    compareAfter: "Стало",
    compareDesktop: "Компьютер",
    compareMobile: "Телефон",
    compareSlider: "Сдвиньте, чтобы сравнить сайт до и после",
    compareAltBefore: "{name}: первый экран старого сайта — {view}",
    compareAltAfter: "{name}: первый экран сайта, который сделали мы — {view}",
    compareNote: "Снимки — {date}. Слева {site}, справа наша версия.",
    compareParts: {
      hero: "Первый экран",
      calculator: "Расчёт стоимости",
      picker: "Подбор квартиры",
      showcase: "Витрина наборов",
      catalog: "Каталог",
      product: "Страница товара",
      themes: "Тематические наборы",
  ...
  contact: {
    ...
    directTitle: "Позвоните или напишите — ответит человек из команды",
    call: "Позвонить",
  ...
  chat: {
    ...
    minuteTitle: "Минута на скидку 30%",
    minuteText: "Напишите нашему ассистенту здесь или в Telegram, пока идёт таймер, — и скидка 30% на проект закрепится за вами.",
    minuteChat: "Написать здесь",
    minuteTelegram: "В Telegram",
    minuteHide: "Скрыть",
    minuteCounting: "Напишите в течение {t} — скидка 30% закрепится за вами",
    minuteClaiming: "Закрепляем скидку…",
    minuteWon: "Вы написали в первую минуту — скидка 30% на проект закреплена за вами. Менеджер учтёт её в расчёте.",
  },
  /**
  ...
  audit: {
    ...
    checking: "Проверяем…",
    scoreLabel: "Оценка",
    seoTitle: "Видимость в Google",
    seoNote: "Отдельный счёт: что стоит между вашим сайтом и поисковой выдачей. Он не про то, обратится ли человек, открывший сайт, — он про то, дойдёт ли он до вас из поиска.",
    seoGoodGrade: "Для поиска всё в порядке",
    seoFixableGrade: "Есть что поправить",
    seoPoorGrade: "В поиске вас находят плохо",
    seoBlockedGrade: "Сайта в поиске нет",
    seoRest: "Ещё {n} по этой части разберём с менеджером — покажем на вашем сайте, что именно и в каком порядке чинить.",
    seoNone: "По видимости в поиске замечаний нет.",
    seoUnmeasured: "Сайт не открылся — о видимости в поиске по нему сказать нечего.",
    lossTitle: "Сколько обращений это стоит",
    lossBody: "Из каждых ста человек, которые дошли до сайта и готовы были обратиться, на найденных местах теряются примерно {lo}–{hi}.",
    lossHow: "Это оценка по нашим допущениям, а не замер вашей статистики: мы не знаем вашу посещаемость и не подставляем её. Считаем на сто посетителей — умножьте на свои цифры.",
    lossNone: "На найденных местах путь к обращению не перекрыт.",
    lossAsk: "Сколько обращений в месяц вы получаете сейчас?",
    lossAskHint: "Звонки, сообщения, заявки — как считаете сами. Число никуда не уходит: считаем прямо здесь, в браузере.",
    lossResult: "Получая {n}, вы теряете ещё примерно {lo}–{hi} в месяц.",
    noFindings: "Претензий нет. Сайт в порядке по всем нашим проверкам.",
    sameNiche: "Разборы сайтов из вашей ниши — те же ошибки у других, и что мы с ними делали:",
    fixLabel: "Что делаем",
  ...
  partners: {
    ...
    lead: "Приводите клиентов — получайте 20 % от чистой прибыли каждого их проекта. Без ограничений по числу клиентов, с выплатой раз в месяц.",
    howTitle: "Как это работает",
    step1: "Напишите нашему боту команду /ref — он выдаст вашу личную ссылку. Можно завести отдельную под каждый канал: Telegram-канал, Instagram, рассылку.",
    step2: "Человек открывает ссылку, оставляет заявку на сайте или пишет боту. Сайт помнит, что он пришёл от вас, 90 дней.",
    step3: "Когда его проект оплачен целиком, начисление появляется у вас в боте. Пока клиент платит частями — оно ждёт.",
    ratesTitle: "Сколько",
    rateBase: "20 % от чистой прибыли проекта — базовая ставка с первого клиента.",
    rateProven: "25 % — после трёх оплаченных проектов по вашим клиентам.",
    rateNote: "Чистая прибыль — это сумма по договору минус налог и себестоимость разработки. Процент считается с каждого проекта клиента, включая следующие.",
    perkTitle: "Бонус вашей аудитории",
    perk: "К ссылке можно прикрепить скидку 5, 10 или 15 % на первый проект — это ваш оффер аудитории. Ваш процент идёт сверху.",
    payoutTitle: "Выплаты",
    payout: "С первого рабочего дня месяца, от 50 $, на USDT TRC-20 или по реквизитам — командой /payout в боте. Владелец студии переводит деньги лично и подтверждает в боте.",
    fair: "Не засчитывается, если партнёр привёл сам себя или клиент уже работал со студией до ссылки.",
    cta: "Получить ссылку в боте",
    bloggers: "Ведёте блог или канал? Напишите — обсудим отдельные условия под вашу аудиторию.",
  },
  seo: {
    home: {
...
const en: Dictionary = {
  ...
  cases: {
    ...
    compareHint: "Section by section, the same points on both: on the left, the site as it was; on the right, the one we built. Drag the slider.",
    compareBefore: "Before",
    compareAfter: "After",
    compareDesktop: "Desktop",
    compareMobile: "Phone",
    compareSlider: "Drag to compare the site before and after",
    compareAltBefore: "{name}: first screen of the old site — {view}",
    compareAltAfter: "{name}: first screen of the site we built — {view}",
    compareNote: "Captured {date}. Left: {site}; right: our version.",
    compareParts: {
      hero: "First screen",
      calculator: "Price estimate",
      picker: "Apartment finder",
      showcase: "Featured sets",
      catalog: "Catalogue",
  ...
  contact: {
    ...
    directTitle: "Call or message us — a person from the team will answer",
    call: "Call",
  ...
  chat: {
    ...
    minuteTitle: "One minute to lock in 30% off",
    minuteText: "Message our assistant here or on Telegram while the timer runs, and 30% off your project is locked in for you.",
    minuteChat: "Write here",
    minuteTelegram: "Telegram",
    minuteHide: "Hide",
    minuteCounting: "Write within {t} — 30% off is yours",
    minuteClaiming: "Locking in your discount…",
    minuteWon: "You wrote within the first minute — 30% off your project is locked in for you. The manager will apply it to the quote.",
  },
  products: {
  ...
  audit: {
    ...
    checking: "Checking…",
    scoreLabel: "Score",
    seoTitle: "Visibility in Google",
    seoNote: "A separate score: what stands between your site and the search results. It is not about whether a visitor who opened the site will get in touch — it is about whether they reach you from search at all.",
    seoGoodGrade: "Search-wise you are fine",
    seoFixableGrade: "There is work to do",
    seoPoorGrade: "Search barely finds you",
    seoBlockedGrade: "The site is not in search at all",
    seoRest: "{n} more on this side we will go through with a manager — on your own site, in the order they should be fixed.",
    seoNone: "Nothing to flag on search visibility.",
    seoUnmeasured: "The site did not open, so there is nothing to say about its search visibility.",
    lossTitle: "What this costs in enquiries",
    lossBody: "Of every hundred people who reach the site ready to get in touch, roughly {lo}–{hi} are lost at the points we found.",
    lossHow: "This is an estimate from our stated assumptions, not a reading of your analytics: we don't know your traffic and don't invent it. The figure is per hundred visitors — multiply by your own numbers.",
    lossNone: "Nothing we found blocks the path to an enquiry.",
    lossAsk: "How many enquiries a month do you get now?",
    lossAskHint: "Calls, messages, form submissions — however you count them. The number goes nowhere: the maths happens here, in your browser.",
    lossResult: "Getting {n}, you lose roughly another {lo}–{hi} a month.",
    noFindings: "Nothing to complain about. The site passes every check we run.",
    sameNiche: "Teardowns of sites in your niche:",
  ...
  partners: {
    ...
    lead: "Bring clients and earn 20% of the net profit of every project they order. No limit on the number of clients, payouts once a month.",
    howTitle: "How it works",
    step1: "Send /ref to our bot — it gives you a personal link. You can create a separate one per channel: a Telegram channel, Instagram, a newsletter.",
    step2: "A person opens the link, leaves a request on the site or writes to the bot. The site remembers they came from you for 90 days.",
    step3: "Once their project is paid in full, the accrual shows up in your bot. While the client pays in instalments, it waits.",
    ratesTitle: "How much",
    rateBase: "20% of the project's net profit — the base rate from the first client.",
    rateProven: "25% — after three fully paid projects from your clients.",
    rateNote: "Net profit is the contract amount minus tax and development cost. The percentage applies to every project of the client, including the next ones.",
    perkTitle: "A bonus for your audience",
    perk: "Attach a 5, 10 or 15% discount on the first project to your link — that's your offer to your audience. Your percentage comes on top.",
    payoutTitle: "Payouts",
    payout: "From the first business day of the month, from $50, to USDT TRC-20 or bank details — with /payout in the bot. The studio owner sends the money personally and confirms in the bot.",
    fair: "Not counted if a partner refers themselves or the client already worked with the studio before the link.",
    cta: "Get your link in the bot",
    bloggers: "Run a blog or a channel? Write to us — we'll discuss individual terms for your audience.",
  },
  seo: {
    home: {
...
const uz: Dictionary = {
  ...
  cases: {
    ...
    compareHint: "Bo‘limma-bo‘lim, aynan o‘sha joylarda: chapda sayt qanday bo‘lgan, o‘ngda — biz qilgani. Slayderni suring.",
    compareBefore: "Oldin",
    compareAfter: "Keyin",
    compareDesktop: "Kompyuter",
    compareMobile: "Telefon",
    compareSlider: "Saytni oldin va keyin solishtirish uchun suring",
    compareAltBefore: "{name}: eski saytning birinchi ekrani — {view}",
    compareAltAfter: "{name}: biz qilgan saytning birinchi ekrani — {view}",
    compareNote: "Suratlar sanasi — {date}. Chapda {site}, o‘ngda bizning versiya.",
    compareParts: {
      hero: "Birinchi ekran",
      calculator: "Narxni hisoblash",
      picker: "Kvartira tanlash",
      showcase: "Mashhur to‘plamlar",
      catalog: "Katalog",
      product: "Mahsulot sahifasi",
      themes: "Mavzuli to‘plamlar",
      projects: "Turar joy majmualari",
      works: "Ishlar",
      commerce: "Tijorat binolari",
      mortgage: "Ipoteka",
      quality: "Sifat",
      production: "Ishlab chiqarish",
      steps: "Ish bosqichlari",
      materials: "Materiallar va brendlar",
      clients: "Mijozlar va fikrlar",
  ...
  contact: {
    ...
    directTitle: "Qo‘ng‘iroq qiling yoki yozing — jamoamizdan odam javob beradi",
  ...
  chat: {
    ...
    minuteTitle: "30% chegirma uchun bir daqiqa",
    minuteText: "Taymer ishlayotganda yordamchimizga shu yerda yoki Telegramda yozing — loyihaga 30% chegirma siz uchun band qilinadi.",
    minuteChat: "Shu yerda yozish",
    minuteTelegram: "Telegramda",
    minuteHide: "Yashirish",
    minuteCounting: "{t} ichida yozing — 30% chegirma sizniki bo‘ladi",
    minuteClaiming: "Chegirmani band qilyapmiz…",
    minuteWon: "Birinchi daqiqada yozdingiz — loyihaga 30% chegirma siz uchun band qilindi. Menejer uni hisob-kitobda inobatga oladi.",
  },
  products: {
  ...
  audit: {
    ...
    scoreLabel: "Baho",
    seoTitle: "Google\u2019da ko\u2018rinish",
    seoNote: "Alohida hisob: saytingiz bilan qidiruv natijalari o\u2018rtasida nima turibdi. Bu saytni ochgan odam murojaat qiladimi degani emas \u2014 bu umuman qidiruvdan sizga yetib keladimi degani.",
    seoGoodGrade: "Qidiruv uchun hammasi joyida",
    seoFixableGrade: "Tuzatadigan joylar bor",
    seoPoorGrade: "Qidiruvda sizni yomon topishadi",
    seoBlockedGrade: "Sayt qidiruvda yo\u2018q",
    seoRest: "Bu bo\u2018yicha yana {n} ta izohni menejer bilan ko\u2018rib chiqamiz \u2014 saytingizda nimani va qanday tartibda tuzatish kerakligini ko\u2018rsatamiz.",
    seoNone: "Qidiruvdagi ko\u2018rinish bo\u2018yicha izohlar yo\u2018q.",
    seoUnmeasured: "Sayt ochilmadi \u2014 uning qidiruvdagi ko\u2018rinishi haqida aytadigan narsa yo\u2018q.",
    lossTitle: "Bu nechta murojaatga tushadi",
    lossBody: "Saytga kirgan va murojaat qilishga tayyor har yuz kishidan topilgan joylarda taxminan {lo}–{hi} tasi yo‘qoladi.",
    lossHow: "Bu — bizning ochiq aytilgan taxminlarimiz asosidagi baho, sizning statistikangiz o‘lchovi emas: tashriflaringizni bilmaymiz va o‘ylab topmaymiz. Hisob yuz tashrifga — o‘z raqamlaringizga ko‘paytiring.",
    lossNone: "Topilganlar murojaat yo‘lini to‘smaydi.",
    lossAsk: "Hozir oyiga nechta murojaat olasiz?",
    lossAskHint: "Qo‘ng‘iroq, xabar, ariza — o‘zingiz qanday sanasangiz. Raqam hech qayerga ketmaydi: hisob shu yerda, brauzeringizda.",
    lossResult: "{n} ta olib, oyiga yana taxminan {lo}–{hi} tasini yo‘qotasiz.",
    noFindings: "E'tirozlar yo'q. Sayt barcha tekshiruvlarimizdan o'tdi.",
    sameNiche: "Sizning yo'nalishingizdagi saytlar tahlili — boshqalarda ham xuddi shu xatolar va biz ular bilan nima qilganimiz:",
  ...
  partners: {
    ...
    lead: "Mijozlarni olib keling — ularning har bir loyihasi sof foydasidan 20 % oling. Mijozlar soni cheklanmagan, to'lov oyiga bir marta.",
    howTitle: "Bu qanday ishlaydi",
    step1: "Botimizga /ref buyrug'ini yozing — u sizga shaxsiy havola beradi. Har bir kanal uchun alohida havola ochish mumkin: Telegram-kanal, Instagram, xabarnoma.",
    step2: "Odam havolani ochadi, saytda so'rov qoldiradi yoki botga yozadi. Sayt uning sizdan kelganini 90 kun eslab qoladi.",
    step3: "Uning loyihasi to'liq to'langach, hisoblash botingizda paydo bo'ladi. Mijoz bo'lib-bo'lib to'layotganda — u kutadi.",
    ratesTitle: "Qancha",
    rateBase: "Loyiha sof foydasining 20 % — birinchi mijozdan boshlab asosiy stavka.",
    rateProven: "25 % — mijozlaringiz bo'yicha uchta to'liq to'langan loyihadan keyin.",
    rateNote: "Sof foyda — shartnoma summasidan soliq va ishlab chiqish tannarxi ayirilgani. Foiz mijozning har bir loyihasidan, keyingilarini ham qo'shib hisoblanadi.",
    perkTitle: "Auditoriyangiz uchun bonus",
    perk: "Havolaga birinchi loyihaga 5, 10 yoki 15 % chegirma biriktirish mumkin — bu sizning auditoriyangizga taklifingiz. Sizning foizingiz ustidan boradi.",
    payoutTitle: "To'lovlar",
    payout: "Oyning birinchi ish kunidan, 50 $ dan, USDT TRC-20 ga yoki rekvizitlar bo'yicha — botdagi /payout buyrug'i bilan. Studiya egasi pulni shaxsan o'tkazadi va botda tasdiqlaydi.",
    fair: "Hamkor o'zini o'zi olib kelsa yoki mijoz havoladan oldin studiya bilan ishlagan bo'lsa — hisobga olinmaydi.",
    cta: "Botda havola olish",
    bloggers: "Blog yoki kanal yuritasizmi? Yozing — auditoriyangiz uchun alohida shartlarni muhokama qilamiz.",
  },
  seo: {
    home: {
...
const zh: Dictionary = {
  ...
  cases: {
    ...
    year: "年份",
    compareTitle: "改版前后",
    compareHint: "逐个板块、在相同位置对比：左边是原来的网站，右边是我们做的网站。拖动滑块即可。",
    compareBefore: "改版前",
    compareAfter: "改版后",
    compareDesktop: "电脑",
    compareMobile: "手机",
    compareSlider: "拖动以对比网站改版前后",
    compareAltBefore: "{name}：旧网站首屏 — {view}",
    compareAltAfter: "{name}：我们制作的网站首屏 — {view}",
    compareNote: "截图拍摄于 {date}。左边是 {site}，右边是我们的版本。",
    compareParts: {
      hero: "首屏",
      calculator: "价格估算",
      picker: "选房",
  ...
  chat: {
    ...
    minuteTitle: "一分钟锁定 30% 折扣",
    minuteText: "在倒计时结束前，在这里或通过 Telegram 给我们的助手发消息 —— 项目 30% 的折扣即为您锁定。",
    minuteChat: "在这里留言",
    minuteTelegram: "Telegram",
    minuteHide: "隐藏",
    minuteCounting: "{t} 内留言 —— 30% 折扣归您",
    minuteClaiming: "正在为您锁定折扣…",
    minuteWon: "您在第一分钟内留言了 —— 项目 30% 的折扣已为您锁定，客户经理会在报价中计入。",
  },
  products: {
    title: "成品产品",
  ...
  audit: {
    ...
    checking: "检查中…",
    scoreLabel: "评分",
    seoTitle: "在 Google 中的可见度",
    seoNote: "单独的一项评分：横在你的网站与搜索结果之间的东西。它衡量的不是访客打开网站后会不会联系你，而是他们能否从搜索中找到你。",
    seoGoodGrade: "搜索方面没有问题",
    seoFixableGrade: "有需要修的地方",
    seoPoorGrade: "搜索很难找到你",
    seoBlockedGrade: "网站根本不在搜索里",
    seoRest: "这方面还有 {n} 处，我们会和客户经理一起过一遍——在你自己的网站上，按该修的先后顺序。",
    seoNone: "搜索可见度方面没有问题。",
    seoUnmeasured: "网站未能打开，无法评估它在搜索中的可见度。",
    lossTitle: "这会损失多少咨询",
    lossBody: "每一百位打开网站并准备联系你的访客中，在我们发现的问题上大约流失 {lo}–{hi} 位。",
    lossHow: "这是基于我们公开说明的假设做出的估算，不是对你统计数据的测量：我们不知道你的访问量，也不会编造。按每一百位访客计算——请乘以你自己的数字。",
    lossNone: "我们发现的问题没有阻断联系你的路径。",
    lossAsk: "你现在每月收到多少咨询？",
    lossAskHint: "电话、消息、表单提交——按你自己的口径计算。这个数字不会外传：计算就在你的浏览器里完成。",
    lossResult: "在收到 {n} 条的同时，你每月还额外流失约 {lo}–{hi} 条。",
  ...
  partners: {
    title: "合作伙伴计划",
    lead: "介绍客户，即可获得其每个项目净利润的 20%。客户数量不限，每月结算一次。",
    howTitle: "如何运作",
    step1: "向我们的机器人发送 /ref，它会给您一个专属链接。可以为每个渠道单独创建：Telegram 频道、Instagram、邮件列表。",
    step2: "对方打开链接，在网站上留下需求或给机器人写信。网站会记住他来自您，为期 90 天。",
    step3: "当他的项目全额付款后，佣金会出现在您的机器人中。客户分期付款期间，佣金处于等待状态。",
    ratesTitle: "金额",
    rateBase: "项目净利润的 20% —— 从第一位客户起的基础比例。",
    rateProven: "25% —— 您介绍的客户完成三个全额付款项目之后。",
    rateNote: "净利润 = 合同金额 − 税费 − 开发成本。比例适用于该客户的每一个项目，包括后续项目。",
    perkTitle: "给您受众的福利",
    perk: "可以为链接附加首个项目 5%、10% 或 15% 的折扣 —— 这是您给受众的优惠。您的比例在此之上计算。",
    payoutTitle: "结算",
    payout: "每月第一个工作日起，50 美元起，支付到 USDT TRC-20 或按您的收款信息 —— 在机器人中使用 /payout。工作室负责人亲自转账并在机器人中确认。",
    fair: "如果合作伙伴介绍的是自己，或客户在链接之前已与工作室合作，则不计入。",
    cta: "在机器人中获取链接",
    bloggers: "您运营博客或频道？请联系我们 —— 我们会为您的受众商定单独的条件。",
  },
  seo: {
    home: {
