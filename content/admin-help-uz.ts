        ...
        },
        {
          ...
          body: {
            ...
            head: [
              ...
              "Besh urinishdan keyingi «Не доставлено» — bot odamga yozolmayotganini bildiradi: u botni bloklamaganini tekshirib ko‘rsin. Serverning Telegram bilan aloqasi uzilishi urinish hisoblanmaydi — eslatma aloqa tiklanganda keladi.",
            ],
            admin: [
              ...
              "Besh urinishdan keyingi «Не доставлено» — bot odamga yozolmayapti: bot bloklangan yoki odam bir marta ham «Старт» tugmasini bosmagan. Urinishlar faqat Telegram javob berganda hisoblanadi: server Telegramni umuman ko‘rmasa, eslatma tashlab yuborilmaydi, kutadi.",
            ],
          },
        },
        {
