...
export const company = {
  ...
  // ─── Контакты ──────────────────────────────────────────────────────────────
  // TODO(владелец): заменить на боевые перед публикацией — эти же значения
  // уходят в разметку LocalBusiness, а неверный NAP портит локальное SEO.
  email: "hello@devuz.studio",
  phone: "+998 90 000 00 00",
  phoneHref: "+998900000000",
  telegram: "devuz_studio",
  ...
  social: {
    telegram: "https://t.me/devuz_studio",
