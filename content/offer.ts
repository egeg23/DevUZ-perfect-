 ...
 * Публичная оферта.
 *
 * ВНИМАНИЕ, TODO(владелец): текст написан по структуре, принятой для
 * договоров оферты в Узбекистане, но юристом не проверен. До первого
 * принятого платежа его должен прочитать юрист — прежде всего разделы о
 * цене, возврате и ответственности. Это не формальность: оферта — это
 * договор, который заключается без подписи, и всё, чего в нём нет,
 * толкуется не в пользу того, кто его составил.
 *
