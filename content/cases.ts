...
export const cases: Case[] = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { value: "16", label: { ru: "сезонов в барабане архива", en: "seasons in the archive drum", uz: "arxiv barabanidagi mavsum", zh: "档案转盘中的销售季" } },
    ],
  },
  {
    slug: "tezketkaz",
  ...
  },
  {
    ...
    tier: 2,
    niches: ["детская школа", "IT-школа для детей", "программирование для детей", "учебный центр", "образование", "курсы для школьников", "kids coding school", "o‘quv markazi", "bolalar uchun dasturlash", "少儿编程"],
    forNiches: [],
    accent: "blue",
    category: {
      ru: "Сайт-платформа детской IT-школы",
      en: "Platform site for a kids' IT school",
      uz: "Bolalar IT-maktabi uchun sayt-platforma",
      zh: "少儿编程学校的平台型网站",
    },
    summary: {
      ru: "Школа программирования для детей 6–17 лет, у которой не было сайта — только соцсети. Сайт, где родитель сначала сам собирает первую программу, а потом видит ступени, преподавателя, призы за старание и кабинет с успехами ребёнка.",
      en: "A coding school for children aged 6–17 that had no website — only social media. A site where a parent first builds a program with their own hands, then sees the learning levels, the teacher, rewards for effort and a dashboard of the child's progress.",
      uz: "Sayti bo‘lmagan, faqat ijtimoiy tarmoqlari bor 6–17 yoshli bolalar uchun dasturlash maktabi. Ota-ona avval o‘zi birinchi dasturni yig‘adigan, keyin esa bosqichlarni, o‘qituvchini, harakat uchun sovg‘alarni va farzandining yutuqlari kabinetini ko‘radigan sayt.",
      zh: "一所面向 6–17 岁孩子的编程学校，此前没有网站，只有社交媒体账号。在这个网站上，家长先亲手拼出第一个程序，再看到学习阶梯、老师、努力换来的奖品，以及记录孩子进步的家长后台。",
    },
    description: {
      ru: "Сайт отвечает на вопросы родителя в том порядке, в каком он их задаёт. «Ему будет интересно?» — на первом экране песочница: ракета в форме знака школы летит к звезде по командам из блоков, три уровня за полминуты — последовательность, повороты, цикл, — и рядом та же программа текстом. «С чего начать?» — треугольник-дельта из логотипа наполняется снизу вверх при прокрутке: три ступени от первой мышки до настоящего кода, и подбор ступени за три вопроса, который сам заполняет запись. «Это работает?» — истории учеников с ссылкой на пост в канале, где школа их рассказала. «Как мотивировать?» — копилка Deltcoin: баллы за активность на уроках и настоящие призы по ценам школы. «Как я узнаю, что он учится?» — кабинет родителя с посещениями, прогрессом и проектами и открытый экзамен, на который школа зовёт родителей сама. Всё собрано из того, что школа публикует о себе; чего она не публикует — цен, адреса, расписания, — на сайте нет.",
      en: "The site answers a parent's questions in the order they ask them. «Will my child enjoy it?» — the first screen is a sandbox: a rocket shaped like the school's logo flies to a star on block commands, three levels in half a minute — sequence, turns, a loop — with the same program shown as text alongside. «Where do we start?» — the delta triangle from the logo fills from the bottom up as you scroll: three levels from the first mouse click to real code, plus a three-question level picker that fills in the sign-up form by itself. «Does it work?» — students' stories, each linked to the channel post where the school told it. «How do I keep them motivated?» — a Deltcoin piggy bank: points for activity in class and real prizes at the school's own prices. «How will I know they are learning?» — a parent dashboard with attendance, progress and projects, and an open exam the school invites parents to. Everything is built from what the school publishes about itself; what it does not publish — prices, address, timetable — is not on the site.",
      uz: "Sayt ota-onaning savollariga u beradigan tartibda javob beradi. «Unga qiziq bo‘ladimi?» — birinchi ekranda qumdon: maktab belgisi shaklidagi raketa bloklardan tuzilgan buyruqlar bilan yulduzga uchadi, yarim daqiqada uch daraja — ketma-ketlik, burilishlar, sikl — va yonida o‘sha dastur matn ko‘rinishida. «Nimadan boshlash kerak?» — logotipdagi delta-uchburchak skroll bilan pastdan yuqoriga to‘ladi: birinchi sichqonchadan haqiqiy kodgacha uch bosqich va ro‘yxatdan o‘tish shaklini o‘zi to‘ldiradigan uch savollik bosqich tanlovi. «Bu ishlaydimi?» — o‘quvchilar hikoyalari, har biri maktab uni aytib bergan kanal postiga havola bilan. «Qanday rag‘batlantirish kerak?» — Deltcoin cho‘chqachasi: darsdagi faollik uchun ballar va maktab narxlaridagi haqiqiy sovg‘alar. «U o‘qiyotganini qanday bilaman?» — davomat, o‘sish va loyihalar ko‘rinadigan ota-ona kabineti hamda maktabning o‘zi ota-onalarni chaqiradigan ochiq imtihon. Hammasi maktab o‘zi haqida e’lon qilgan ma’lumotlardan yig‘ilgan; u e’lon qilmagan narsa — narxlar, manzil, jadval — saytda yo‘q.",
      zh: "网站按家长提问的顺序作答。「孩子会感兴趣吗？」—— 首屏是一个沙盒：一枚学校标志形状的火箭按积木指令飞向星星，半分钟三关 —— 顺序、转向、循环 —— 旁边同步显示同一段程序的文字形式。「从哪里开始？」—— 标志里的三角形 delta 随滚动自下而上被填满：从第一次握鼠标到真正写代码的三级阶梯，外加一个三问式阶梯推荐，会自动填好报名表。「真的有效吗？」—— 学员故事，每一则都链接到学校在频道中讲述它的原帖。「怎么激励孩子？」—— Deltcoin 存钱罐：课堂积极表现得积分，按学校自己的定价兑换真实奖品。「我怎么知道他在学习？」—— 可查看出勤、进步与作品的家长后台，以及学校主动邀请家长参加的公开考试。一切都取自学校公开发布的信息；学校未公布的内容 —— 价格、地址、课表 —— 网站上一概没有。",
    },
    tech: ["Next.js 16", "React 19", "TypeScript", "Tailwind CSS v4"],
    metrics: [
      { value: "30", label: { ru: "секунд до первой программы прямо на сайте", en: "seconds to a first program right on the site", uz: "soniyada saytning o‘zida birinchi dastur", zh: "秒即可在网站上完成第一个程序" } },
      { value: "3", label: { ru: "ступени от первой мышки до кода", en: "levels from first mouse click to code", uz: "birinchi sichqonchadan kodgacha bosqich", zh: "从鼠标到代码的学习阶梯" } },
      { value: "4", label: { ru: "настоящих приза за Deltcoin", en: "real prizes for Deltcoin", uz: "Deltcoin uchun haqiqiy sovg‘a", zh: "可用 Deltcoin 兑换的真实奖品" } },
    ],
  },
  {
    slug: "usta",
