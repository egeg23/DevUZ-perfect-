 ...
 *
 * Как и оферта, принята владельцем как есть 12 сентября 2026 года и
 * юристом не проверялась. Место, от формулировки которого зависит больше
 * всего, — раздел 2, что покупателю запрещено: именно он отделяет «купил и
 * пользуюсь» от «купил и продаю то же самое рядом», и именно по нему
 * придётся что-то предъявлять, если дойдёт до этого.
 *
